...
sudo strip ~/VOLVOX/src/VOLVOXd
sudo strip ~/VOLVOX/src/qt/VOLVOX-qt
sudo make install
else
echo "Compile fail not VOLVOX-qt present"
fi
...
mkdir ~/.VOLVOX
cp ~/.VOLVOX/VOLVOX.conf ~/.VOLVOX/VOLVOX.bak
echo "rpcuser="$(head /dev/urandom | tr -dc A-Za-z0-9 | head -c 26 ; echo '') '\n'"rpcpassword="$(head /dev/urandom | tr -dc A-Za-z0-9 | head -c 26 ; echo '') '\n'"rpcport=19056" '\n'"port=19156" '\n'"daemon=1" '\n'"listen=1" '\n'"server=1" '\n'"addnode=103.18.40.125:19156" '\n'"addnode=104.131.144.82:19156" '\n'"addnode=138.197.68.130:19156" '\n'"addnode=144.76.167.66:19156" '\n'"addnode=152.186.36.86:19156" '\n'"addnode=159.203.121.202:19156" '\n'"addnode=172.104.157.38:19156" '\n'"addnode=192.99.7.127:19156" '\n'"addnode=219.89.84.46:19156" '\n'"addnode=45.32.129.168:19156" '\n'"addnode=45.55.59.206:19156" '\n'"addnode=46.4.64.68:19156" '\n'"addnode=51.15.46.1:19156" '\n'"addnode=52.9.109.214:19156" '\n'"addnode=66.55.64.183:19156" '\n'"addnode=67.167.207.164:19156" '\n'"addnode=78.46.190.152:19156"> ~/.VOLVOX/VOLVOX.conf

#// Extract http link, download blockchain and install it.


echo "You can download the partially presynced blockchain from: https://github.com/VolvoxCoin/VOLVOX/releases/tag/b385"
#echo -n "Do you wish to download the complete VOLVOX Blockchain (y/n)?"
#read answer
...
#    do
#    sleep 1
#    echo "wget" $(lynx --dump --listonly https://VolvoxCoin.de | grep -o "https:*.*zip") > link.sh
#    sleep 1
#    sh link.sh
#    done
#    
...
#    md5sum VOLVOX-Blockchain*.zip > md5
...
sudo cp ~/VOLVOX/src/qt/res/icons/VOLVOX.png /usr/share/icons/
echo '#!/usr/bin/env xdg-open''\n'"[Desktop Entry]"'\n'"Version=1.0"'\n'"Type=Application"'\n'"Terminal=false"'\n'"Icon[en]=/usr/share/icons/VOLVOX.png"'\n'"Name[en]=VOLVOX"'\n'"Exec=VOLVOX-qt"'\n'"Name=VOLVOX"'\n'"Icon=/usr/share/icons/VOLVOX.png"'\n'"Categories=Network;Internet;" > ~/Desktop/VOLVOX.desktop
sudo chmod +x ~/Desktop/VOLVOX.desktop
sudo cp ~/Desktop/VOLVOX.desktop /usr/share/applications/VOLVOX.desktop
sudo chmod +x /usr/share/applications/VOLVOX.desktop

# Erase all VOLVOX compilation directory , cleaning
...
VOLVOX-qt
cp ~/.VOLVOX/wallet.dat ~/VOLVOXwallet.bak
