...
static const char *strDNSSeed[][2] = { //TODO: add more
    {"145.239.244.23", "145.239.244.23"},
    {"145.239.244.73", "145.239.244.73"}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. VOLVOX is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    */
    ...
    // volvox: mint proof-of-stake blocks in the background
